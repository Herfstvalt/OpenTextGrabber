...
```bash
git clone https://github.com/Herfstvalt/OpenTextSniper.git
cd OpenTextSniper
chmod +x build.sh
./build.sh
open build/OpenTextSniper.app
```
...
|---------|----------------|---------------------|
| [textsniper.app](https://textsniper.app/) | The core concept — select a screen region, OCR it, copy to clipboard. TextSniper proved this workflow is indispensable and inspired OpenTextSniper as a free, open-source alternative. | The entire app architecture: hotkey → region selection → Vision OCR → clipboard |
